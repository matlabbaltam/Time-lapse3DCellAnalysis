...
def main(prob_map_dir, testing_data_dir, min_distance, label_threshold, black_threshold):
    minimum = 50
...
if __name__== "__main__":
    main('source/prob_map/', '/source/data/celldata', min_distance, label_threshold, black_threshold)
